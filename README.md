...
It supports playlist as well as single episodes. This fork only extracting jp video only (labeled sub in hianime)

## Installation
If you are using python, you can run the following command to install this plugin:
```bash
python -m pip install -U https://github.com/yaaacha/yt-dlp-hianime/archive/master.zip
```
